...
namespace UnitySkills
{
    ...
    public static class SkillInstaller
    {
        ...
        private static string GetSkillTemplateRoot()
        {
            ...
            // 2. Try this project's third-party plugin install location.
            templateRoot = Path.GetFullPath(Path.Combine(
            ...
            // 3. Try inside UPM package (unity-skills~ is a tilde-hidden dir bundled with the package)
            ...
            {
                packageInfo = UnityEditor.PackageManager.PackageInfo.FindForAssetPath("Assets/Plugin3rd/com.besty.unity-skills");
                if (packageInfo != null)
                    resolvedPath = packageInfo.resolvedPath;
            }

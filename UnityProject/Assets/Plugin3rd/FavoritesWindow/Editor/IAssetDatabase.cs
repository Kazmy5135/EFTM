namespace Favorites
{
    ...
    public abstract class AbstractAssetDatabase
	{
		...
		public abstract bool IsValidFolder( string assetPath );
		public abstract string MoveAsset( string oldPath, string newPath );
	...
	public class UnityAssetDatabase : AbstractAssetDatabase
	{
		...
		public override bool IsValidFolder( string assetPath )
		{
			return AssetDatabase.IsValidFolder( assetPath );
		}

		public override string MoveAsset( string oldPath, string newPath )
		{

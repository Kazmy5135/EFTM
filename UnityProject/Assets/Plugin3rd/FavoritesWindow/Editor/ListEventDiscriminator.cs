namespace Favorites
{
	...
	public class ListEventDiscriminator
	{
		...
		public event DropAction WhenDroppedIntoItem;
		...
		public void MouseDropped_IntoItem( int itemIdx )
		{
			Debug.LogFormat( "DropInto({0})", itemIdx );
			this.OnElementsWereDroppedIntoItem( itemIdx );
		}
		...
		private void OnElementsWereDroppedIntoItem( int itemIdx )
		{
			if ( WhenDroppedIntoItem != null )
				WhenDroppedIntoItem( itemIdx );
			isDragging = false;
			itemHitOnMouseDown_Idx = -1;
		}

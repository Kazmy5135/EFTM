...
| 核心掩体战斗 V1 基础方向 | `DESIGN-CORE-COMBAT`、`DDR-001`（accepted） | 尚未建立 | `H5-PEEK-CAMERA-001 V1`（已验证 H5）；Unity 尚未实现 | 003、004 | not_assessed | `Docs/30_Iterations/004-peek-camera/Validation.md` |

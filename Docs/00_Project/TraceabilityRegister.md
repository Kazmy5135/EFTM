...
| 双侧掩体换边与移动观察 | `DESIGN-CORE-COMBAT` / `DDR-001`（008 扩展及移动侧探修订 accepted，2026-09-08） | `TECH-COMBAT-FOUNDATION-V1`（0.80s 横移、前向沿通道、8cm 侧探/2cm 压低/4° 侧倾） | S0～S4 接入完成；移动侧探与相机包络校验已实现，S5/S6 体验门禁待验 | 008 | verifying | [最新批准修订](../30_Iterations/008-cover-side-switch/MovingLeanProposal.md)、[验证记录](../30_Iterations/008-cover-side-switch/Validation.md)；备份基线 `49ce351` 已推送，本次 EditMode 37/37、PlayMode 28/28、Windows 构建通过，真实硬件与手机体验待验 |
